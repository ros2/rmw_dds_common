...
TEST(test_graph_cache, normal_usage)
{
  ...
  {
    // topic1
    {"reader6", "remote_party", "topic1", "Str", true},
    {"reader7", "remote_party", "topic1", "Custom", true},
    // topic2
    {"writer4", "remote_party", "topic2", "Str", false},
    // topic4
    {"writer5", "remote_party", "topic4", "Custom", false},
    {"writer6", "remote_party", "topic4", "Bool", false},
  });
  ...
  remove_participants(graph_cache, {"remote_party"});
...
TEST(test_graph_cache, bad_arguments)
{
  ...
  {
    // topic1
    {"reader1", "some_party", "topic1", "Str", true},
    {"writer1", "some_party", "topic1", "Str", false},
  });
